...
#Hiseq
fnFs_hi<- sort(file.path("Clipped",paste(c(32:37), "_clip_R1.fastq", sep = "")))
fnRs_hi<- sort(file.path("Clipped",paste(c(32:37), "_clip_R2.fastq", sep = ""))) 
filtFs_hi<- sort(file.path("Filtered",paste(c(32:37), "_F_filt.fastq.gz", sep = "")))
filtRs_hi<- sort(file.path("Filtered",paste(c(32:37), "_R_filt.fastq.gz", sep = ""))) 
#Filter and trim
...
#MiSeq 1 - 493:307
fnFs_mi1 <- sort(file.path("Clipped",paste(c(1:31), "_clip_R1.fastq", sep = "")))
fnRs_mi1 <- sort(file.path("Clipped",paste(c(1:31), "_clip_R2.fastq", sep = "")))
filtFs_mi1 <- sort(file.path("Filtered",paste(c(1:31), "_F_filt.fastq.gz", sep = "")))
filtRs_mi1 <- sort(file.path("Filtered",paste(c(1:31), "_R_filt.fastq.gz", sep = "")))
#Filter and trim
