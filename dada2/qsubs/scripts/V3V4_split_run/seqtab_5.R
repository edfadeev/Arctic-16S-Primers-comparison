...
# Learn errors
errF_mi4 <- learnErrors(filtFs_mi4, multithread = TRUE, randomize = TRUE, MAX_CONSIST = 20, verbose = TRUE)
errR_mi4 <- learnErrors(filtRs_mi4, multithread = TRUE, randomize = TRUE, MAX_CONSIST = 20, verbose = TRUE)
# Sample Inference 
