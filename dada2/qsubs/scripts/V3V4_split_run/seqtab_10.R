...
# Learn errors
errF_mi9 <- learnErrors(filtFs_mi9, multithread = TRUE, randomize = TRUE, MAX_CONSIST = 20, verbose = TRUE)
errR_mi9 <- learnErrors(filtRs_mi9, multithread = TRUE, randomize = TRUE, MAX_CONSIST = 20, verbose = TRUE)
# Sample Inference 
