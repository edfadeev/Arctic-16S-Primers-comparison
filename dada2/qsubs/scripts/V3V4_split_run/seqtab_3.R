...
# Learn errors
errF_mi2 <- learnErrors(filtFs_mi2, multithread = TRUE, randomize = TRUE, MAX_CONSIST = 20, verbose = TRUE)
errR_mi2 <- learnErrors(filtRs_mi2, multithread = TRUE, randomize = TRUE, MAX_CONSIST = 20, verbose = TRUE)
# Sample Inference 
