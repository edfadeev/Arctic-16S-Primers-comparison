...
# Learn errors
errF_mi6 <- learnErrors(filtFs_mi6, multithread = TRUE, randomize = TRUE, MAX_CONSIST = 20, verbose = TRUE)
errR_mi6 <- learnErrors(filtRs_mi6, multithread = TRUE, randomize = TRUE, MAX_CONSIST = 20, verbose = TRUE)
# Sample Inference 
