...
fnFs_hi<- sort(c("Clipped/22_clip_R1.fastq","Clipped/23_clip_R1.fastq", "Clipped/26_clip_R1.fastq","Clipped/27_clip_R1.fastq"))
fnRs_hi<- sort(c("Clipped/22_clip_R2.fastq","Clipped/23_clip_R2.fastq", "Clipped/26_clip_R2.fastq","Clipped/27_clip_R2.fastq"))
...
filtFs_hi <- filtFs[names(filtFs) %in% c("22","23","26","27")]
filtRs_hi <- filtRs[names(filtRs) %in% c("22","23","26","27")]

filtFs_mi <- filtFs[!names(filtFs) %in% c("22","23","26","27")]
filtRs_mi <- filtRs[!names(filtRs) %in% c("22","23","26","27")]
